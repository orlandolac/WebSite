 ...
 */
final class Default_Model_Lista_Eleicao {
    ...
    private static $lista = array(
       //2014 => 'Eleições Majoritárias',
         2012 => 'Eleições Municipais',
         2010 => 'Eleições Majoritárias',
         2008 => 'Eleições Municipais',
         2006 => 'Eleições Majoritárias',
         2004 => 'Eleições Municipais',
         2002 => 'Eleições Majoritárias',
         2000 => 'Eleições Municipais',
         1998 => 'Eleições Majoritárias',
         1996 => 'Eleições Municipais',
         1994 => 'Eleições Majoritárias',
    );
