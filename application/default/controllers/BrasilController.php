...
/**
 * Controller do brasil do módulo "default".
 * 
 * @category    Controller
 ...
 * @version     1.14.04.05
 */
class Default_BrasilController extends Pu_Controller_Action {

    public function init(){
        parent::init();
        $this->trilha[] = '<a href="/brasil">Brasil</a>';
    }
    ...
    public function cargosAction(){
        $this->trilha[] = '<a href="/brasil/cargos">Cargos</a>';
    }
    
    public function constituicaoAction(){
        $this->trilha[] = '<a href="/brasil/constituicao">Constituição</a>';
    }
    
    public function eleicoesAction(){
        $this->trilha[] = '<a href="/brasil/eleicoes">Eleições</a>';
    }
    
    public function leisAction(){
        $this->trilha[] = '<a href="/brasil/leis">Leis</a>';
    }
    
    public function territoriosAction(){
        $this->trilha[] = '<a href="/brasil/territorios">Territórios</a>';
    }
