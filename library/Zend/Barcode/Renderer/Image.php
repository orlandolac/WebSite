...
class Zend_Barcode_Renderer_Image extends Zend_Barcode_Renderer_RendererAbstract {
	...
	protected function _drawPolygon($points, $color, $filled = true) {
		$newPoints = array ($points [0] [0] + $this->_leftOffset, $points [0] [1] + $this->_topOffset, $points [1] [0] + $this->_leftOffset, $points [1] [1] + $this->_topOffset, $points [2] [0] + $this->_leftOffset, $points [2] [1] + $this->_topOffset, $points [3] [0] + $this->_leftOffset, $points [3] [1] + $this->_topOffset );
